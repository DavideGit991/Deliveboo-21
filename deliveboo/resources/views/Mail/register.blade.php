                  ...
                  <tr>
                      <td class="esd-email-paddings" valign="top">
                                                                  ...
                                                                  <tr>
                                                                      <td class="esd-container-frame" width="580" valign="top" align="center">
                                                                          <table width="100%" cellspacing="0" cellpadding="0">
                                                                              <tbody>
                                                                                  <tr>
                                                                                      <td class="esd-block-image es-p25t es-p25b es-p10r es-p10l" style="font-size:0" align="center"><a href target="_blank"><img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.fasttrack.co.uk%2Fwp-content%2Fuploads%2Fdeliveroo.png&f=1&nofb=1" alt style="display: block;" width="200"></a></td>
                                                                                  </tr>
                                                                              </tbody>
                                                                          </table>
                                                                      </td>
                          ...
                          <table class="es-content" cellspacing="0" cellpadding="0" align="center">
                              <tbody>
                                  <tr>
                                      <td class="esd-stripe" style="background-color: #00c2b3;" esd-custom-block-id="6340" bgcolor="#ffa73b" align="center">
                                                                              ...
                                                                              <tbody>
                                                                                  <tr>
                                                                                      <td class="esd-block-text es-p20t es-p20b es-p30r es-p30l es-m-txt-l" bgcolor="#ffffff" align="left">
                                                                                          <p><b>{{ $user -> name }}</b> il tuo account è attivo.</p>
                                                                                          <br>
                                                                                          <p>Vai nella tua dashboard e dai vita al tuo ristorante</p>
                                                                                      </td>
                                                                                  </tr>
                                                                                  <tr>
                                                                                  ...
                                                                                  <tr>
                                                                                      <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left">
                                                                                          <p>Se non funziona, copia e incolla il seguente link nel browser:</p>
                                                                                      </td>
                                                                                  </tr>
                                                                                  <tr>
                          ...
                          <table class="es-content" cellspacing="0" cellpadding="0" align="center">
                              <p align="center">© 2021 Deliveroo</p>
                          </table>
                      </td>
                  </tr>
              </tbody>
